            ...
            <div class="card mt-4">
                <div class="card-header">
                    <h4 class="mb-0">Order Summary
                        <a href="order-create.php" class="btn btn-danger float-end">Back to create summary</a>
                    </h4>
                </div>
                ...
                <div class="card-body">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="text-align: center;" colspan="2">
                                                    <h4 style="font-size: 23px; line-height: 30px; margin:2px; padding: 0;">Mistic's Gadgets and Accessories</h4>
                                                    <p style="font-size: 16px; line-height: 24px; margin:2px; padding: 0;">Camachilihan, Bustos, Philippines</p>
                                                </td>
                                            </tr>
                    ...
                    <?php if (isset($_SESSION['productItems'])) : ?>
                        ...
                        <div class="mt-4 text-end">
                            <button type="button" class="btn btn-primary px-4 mx-1" id="saveOrder"><i class="fa-solid fa-floppy-disk"></i> Save</button>
                            <button class="btn btn-warning px-4 mx-1" onclick="printMyBillingArea()"> <i class="fa-solid fa-print"></i> Print</button>
                            <button class="btn btn-info px-4 mx-1" onclick="downloadPdf('<?= $_SESSION['invoice_no']; ?>')"><i class="fa-solid fa-download"></i> Download PDF</button>
